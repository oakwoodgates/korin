...
add_action( 'after_setup_theme', 'korin_custom_header_setup', 15 );
 ...
 * @return void
 */
function korin_custom_header_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'header-text'            => true,
			'uploads'                => true,
			'wp-head-callback'       => 'korin_custom_header_wp_head'
		)
	);
 ...
 * @return void
 */
function korin_custom_header_wp_head() {
