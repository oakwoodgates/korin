...
add_action( 'after_setup_theme', 'korin_custom_background_setup', 15 );
 ...
 * @return void
 */
function korin_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'korin_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function korin_custom_background_callback() {
